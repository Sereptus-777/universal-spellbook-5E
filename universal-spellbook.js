/* ========================================================
   Universal Spellbook v5.9 — FIXED FAVORITES & USE ERROR
   Adds getFavoriteData and getCardData for favorites and use
...
class SpellbookItem extends Item {
  ...
  async getCardData() {
    // Return a simple chat card for the spellbook (e.g., list spells)
    return {
      title: this.name,
